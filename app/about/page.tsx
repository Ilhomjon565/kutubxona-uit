      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Qoraqalpog'iston Respublikasida o'z faoliyatini boshlagan birinchi nodavlat oliy ta'lim muassasalaridan biri",
            "address": {
              "@type": "PostalAddress",
              "addressCountry": "UZ",
            ...
            "award": [
              "Times Higher Education - Reporter status (2024)",
              "UI Green Metric World University Rankings - 1364th place globally, 50th in Uzbekistan (2024)"
            ]
          }),
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
              ...
              >
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
                  <h2 className="text-2xl font-bold text-[#0056b3] mb-4 flex items-center gap-2">
              ...
              >
                ...
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
                  <h2 className="text-2xl font-bold text-[#0056b3] mb-4">Ta'lim Jarayoni</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h3 className="font-bold text-lg mb-2">Ilmiy Faoliyat</h3>
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Konferensiyalar</h3>
                  <p className="text-sm opacity-90">
                    2024-yilda 1 ta respublika miqyosida (Nukus shahrida) va bitta xalqaro konferensiya (Samarqandda) tashkil etildi.
                  </p>
                </div>
                <div>
                  <h3 className="font-bold text-lg mb-2">Xalqaro Hamkorlik</h3>
                  <p className="text-sm opacity-90">
