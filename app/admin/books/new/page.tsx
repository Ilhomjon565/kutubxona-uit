...
import { Book, Category, CreateBookRequest } from '@/types';
...
const NewBookPage: React.FC = () => {
  ...
  const onSubmit = async (data: CreateBookRequest) => {
    try {
      ...
      const response = await booksApi.create(formData as any);
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">📚 Yangi kitob qo'shish</h1>
